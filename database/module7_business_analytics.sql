...
-- Add reporting views for business and referrer analytics without modifying existing tables.
...
FROM users u
-- The explicit collation keeps these views usable when MySQL's connection
-- default differs from the application's utf8mb4_unicode_ci table collation.
